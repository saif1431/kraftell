...
import BuyerPrototypeGrid from "./BuyerPrototypeGrid"
import PrototypeSearchFilter from "../../Manufacturer Components/PrototypeRequestComponents/PrototypeSearchFilter"
...
const mockProjects = [
 ...
 function BuyerPrototypeManagement() {
      ...
      <div className=" mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <BuyerPrototypeGrid  projects={filteredProjects} />
...
export default BuyerPrototypeManagement
