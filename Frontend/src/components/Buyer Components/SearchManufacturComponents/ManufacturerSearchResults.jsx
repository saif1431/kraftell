  ...
  return (
    <div className="lg:px-6" >
      <div className="flex justify-between items-center mb-6">
        <h1 className="lg:text-2xl text-md font-medium">Search Results</h1>
        <div className="flex items-center">
          <span className="mr-2 text-md text-gray-600">Sort by:</span>
          <select className="bg-white  rounded p-1 lg:w-32 ">
            <option>Match %</option>
            <option>Name</option>
